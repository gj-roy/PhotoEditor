...
class StickerBSFragment : BottomSheetDialogFragment() {
    ...
    override fun setupDialog(dialog: Dialog, style: Int) {
        ...
        val contentView = View.inflate(context, R.layout.f_bottom_sticker_emoji_dialog, null)
    ...
    inner class StickerAdapter : RecyclerView.Adapter<StickerAdapter.ViewHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view =
                LayoutInflater.from(parent.context).inflate(R.layout.v_row_sticker, parent, false)
